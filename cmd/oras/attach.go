...
Example - Attach file to the manifest tagged 'test' in an OCI layout folder './oci-layout-root':
  oras attach --oci-layout --artifact-type doc/example ./oci-layout-root:test hi.txt
  `,
