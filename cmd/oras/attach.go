...
Example - Attach file to the manifest tagged 'test' in an OCI layout folder './layout-root':
  oras attach --oci-layout --artifact-type doc/example ./layout-root:test hi.txt
  `,
