...
func TestDocsOptions_RunMarkdownWithHeadersContent(t *testing.T) {
	// Create a temporary directory for output
	tempDir, err := os.MkdirTemp("", "oras-docs-test-header-content-*")
	if err != nil {
		t.Fatalf("Failed to create temp dir: %v", err)
	}
	defer func() { _ = os.RemoveAll(tempDir) }()
...
func TestDocsCmd_ExecuteWithHeaders(t *testing.T) {
	// Create a temporary directory for output
	tempDir, err := os.MkdirTemp("", "oras-docs-test-execute-headers-*")
	if err != nil {
		t.Fatalf("Failed to create temp dir: %v", err)
	}
	defer func() { _ = os.RemoveAll(tempDir) }()
...
func TestDocsCmd_ExecuteMan(t *testing.T) {
	// Create a temporary directory for output
	tempDir, err := os.MkdirTemp("", "oras-docs-test-execute-man-*")
	if err != nil {
		t.Fatalf("Failed to create temp dir: %v", err)
	}
	defer func() { _ = os.RemoveAll(tempDir) }()
...
func TestDocsCmd_ExecuteBash(t *testing.T) {
	// Create a temporary directory for output
	tempDir, err := os.MkdirTemp("", "oras-docs-test-execute-bash-*")
	if err != nil {
		t.Fatalf("Failed to create temp dir: %v", err)
	}
	defer func() { _ = os.RemoveAll(tempDir) }()
...
func TestDocsOptions_InvalidTypeErrorMessage(t *testing.T) {
	// Create a temporary directory for output
	tempDir, err := os.MkdirTemp("", "oras-docs-test-invalid-msg-*")
	if err != nil {
		t.Fatalf("Failed to create temp dir: %v", err)
	}
	defer func() { _ = os.RemoveAll(tempDir) }()
