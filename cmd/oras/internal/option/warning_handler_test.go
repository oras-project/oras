...
func TestWarningHandler_GetHandler(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			wh := &WarningHandler{}
			handler := wh.GetHandler(tt.registry, logger)
...
func TestWarningHandler_GetHandler_DifferentRegistries(t *testing.T) {
	...
	handler1 := wh.GetHandler("registry1.example.com", logger)
	handler2 := wh.GetHandler("registry2.example.com", logger)
...
func TestWarningHandler_GetHandler_Concurrency(t *testing.T) {
	...
	wh := &WarningHandler{}
	handler := wh.GetHandler("localhost:5000", logger)
...
func TestWarningHandler_GetHandler_MultipleHandlersForSameRegistry(t *testing.T) {
	...
	handler1 := wh.GetHandler("localhost:5000", logger)
	handler2 := wh.GetHandler("localhost:5000", logger)
