...
var (
	...
	LinuxAMD64ReferrerState       = match.StateKey{Digest: "57e6462826c8", Name: "application/vnd.oci.image.manifest.v1+json"}
	LinuxAMD64ReferrerConfigState = match.StateKey{Digest: "44136fa355b3", Name: "referrer.image"}
	LayerName                     = "hello.tar"
	ImageStateKey                 = []match.StateKey{
