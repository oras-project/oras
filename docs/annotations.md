...
Making annotations are supported by both the command line tool and the GO package. However, reading the annotations from the remote is only possible with the GO package.
